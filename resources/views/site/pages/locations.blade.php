  ...
  class="flex flex-col min-h-screen">
    ...
    <div class="relative flex flex-col flex-grow max-w-full gap-8 px-4 py-8 sm:px-6 lg:px-8 lg:flex-row">
      ...
      <div id="listing" class="order-2 w-full lg:w-2/3 lg:order-1"> 
        ...
        @include('site.partials.locations.search')
        
        <!-- Listing locations -->     
        @include("site.partials.locations.location-listing")  
        <!-- Pagination -->
        @if(isset($locations))
      ...
      <div class="w-1/3" x-cloak>      
        ...
        >
          ...
          <!-- Sidebar mobile -->
          <x-site.locations.listing.location-filters x-bind:show-filters="showFilters" :isDesktop="false" />
        </div>

          <!-- 2. DESKTOP: sidebar toujours visible -->
        <x-site.locations.listing.location-filters :isDesktop="true" />
      </div>
