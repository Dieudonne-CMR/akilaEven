...
<div x-data="locationDetails()" class="container px-4 py-8 mx-auto max-w-7xl">
    ...
    <div class="flex flex-col gap-8 lg:flex-row">
        ...
        <x-site.events.details.content-section :eventHall="$eventHall" />
        
        <!-- Section tarification (partie droite) -->
        {{-- <x-site.events.details.pricing-section :eventHall="$eventHall" /> --}}
    </div>
    
    <!-- Modale de réservation -->
    <x-site.events.details.reservation-modal :eventHall="$eventHall" />
</div>
...
<script>
    ...
    function locationDetails() {
        return {
            ...
            // Appliquer les dates sélectionnées(bouton "valider")
            applyDates() {
