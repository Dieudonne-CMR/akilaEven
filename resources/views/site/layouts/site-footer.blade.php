...
<footer class="pt-16 pb-8 bg-white text-card-foreground">
  <div class="container px-4 mx-auto">
    <!-- Footer Links Section -->
    <div class="grid grid-cols-2 gap-8 mb-10 md:grid-cols-4">
      <!-- Company Column 1 -->
      <div>
        <h2 class="mb-4 text-sm font-bold tracking-wider uppercase !text-primary">Entreprise</h2>
        <ul class="space-y-3 text-sm text-muted-foreground">
          <li><a class="hover:text-primary" href="{{route('site.about')}}" class="">A propos</a></li>
          <li><a class="hover:text-primary" href="{{ route("site.contact") }}" class="">Contact</a></li>
          <li><a class="hover:text-primary" href="#" class="">Blog</a></li>
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-muted-foreground">
          ...
          <li><a class="hover:text-primary" href="site.locations" class="">Locations</a></li>
      ...
      <!-- Legal Column -->
      {{-- <div>
        <h2 class="mb-4 text-sm font-bold tracking-wider text-gray-900 uppercase">LEGAL</h2>
        <ul class="space-y-3">
          <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Privacy Policy</a></li>
          <li><a href="#" class="text-sm text-gray-600 hover:text-gray-900">Licensing</a></li>
      ...
      <div class="col-span-2">
        ...
        <ul class="space-y-3 text-sm text-muted-foreground">          
          ...
          <li><a class="!text-primary" href="mailto:contact@akilaeven.com">contact@akilaeven.com</a></li>
        </ul>
      </div>
    ...
    <span class="text-xl font-bold text-purple-500ml-2 heading">Akila Immo</span>
      ...
      <div class="mb-6 text-sm text-gray-500">
        © 2025-2025 Akila Even. Tous droits réservés.
      </div>
