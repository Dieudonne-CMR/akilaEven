    ...
    <div class="grid grid-cols-2 gap-8 mb-10 md:grid-cols-4">
      ...
      <div>
        ...
        <ul class="space-y-3 text-sm text-muted-foreground">
          <li><a class="hover:text-primary" href="{{route('site.bl-about.about')}}" class="">A propos</a></li>
          <li><a class="hover:text-primary" href="{{ route("site.bl-contact.contact") }}" class="">Contact</a></li>
