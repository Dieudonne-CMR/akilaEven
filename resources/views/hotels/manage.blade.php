...
@section('content')
        ...
        <div class="dashboard-main-body nft-page">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                {{-- <h6 class="fw-semibold mb-0">Gestion de :@if(session('current_hotel_id'))
                    <li class="nav-item">
                        <span class="nav-link">Hôtel actif : {{ Hotel::find(session('current_hotel_id'))->nom_hotel }}</span>
                    </li>
                    @endif</h6> --}}
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">Gestion de {{ $hotel->nom_hotel }} </li>
                </ul>
            </div>
                                ...
                                <div class="nft-promo-card__inner d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center flex-wrap mt-24 gap-16">
                                            <a href="{{route('rooms.create', $hotel->id)}}"
                                                class="btn rounded-pill border br-white text-white radius-8 px-32 py-11 hover-bg-white text-hover-neutral-900"> Ajouter une chambre </a>
                                            <a href="{{ route('event_halls.create',$hotel->id) }}"
