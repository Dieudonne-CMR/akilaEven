                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        ...
                        <div class="mt-20">
                            ...
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">Turn Your Real
                                    Estate Dreams Into Reality Embrace the Real Estate</a>
                            </h6>
                            <p class="text-line-3 text-neutral-500">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Omnis dolores explicabo corrupti, fuga necessitatibus fugiat
                                adipisci quidem eveniet enim minus.</p>
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        ...
                        <div class="mt-20">
                            ...
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">Your journey to
                                    home ownership starts here</a>
                            </h6>
                            <p class="text-line-3 text-neutral-500">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Omnis dolores explicabo corrupti, fuga necessitatibus fugiat
                                adipisci quidem eveniet enim minus.</p>
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        ...
                        <div class="p-20">
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">How to hire a
                                    right business executive for your company</a>
                            </h6>
                            <p class="text-line-3 text-neutral-500 mb-0">Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Omnis dolores explicabo corrupti, fuga necessitatibus fugiat
                                adipisci quidem eveniet enim minus.</p>
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        ...
                        <div class="p-20">
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">The Gig
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        ...
                        <div class="p-20">
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">The Future of
                ...
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-0">
                        ...
                        <div class="p-20">
                            <h6 class="mb-16">
                                <a href="blog-details.html"
                                    class="text-line-2 text-hover-primary-600 text-xl transition-2">Lorem ipsum
            ...
            <div class="col-xxl-3 col-lg-4 col-sm-6">
                <div class="card h-100 p-0 radius-12 overflow-hidden">
                    <div class="card-body p-24">
                        <h6 class="mb-16">
                            <a href="blog-details.html"
                                class="text-line-2 text-hover-primary-600 text-xl transition-2">Your satisfaction
                                is our top the best priority</a>
                        </h6>
                        <div class="d-flex align-items-center gap-6 justify-content-between flex-wrap mb-16">
                            <div class="d-flex align-items-center gap-8 text-neutral-500 fw-medium">
                                <i class="ri-chat-3-line"></i>
