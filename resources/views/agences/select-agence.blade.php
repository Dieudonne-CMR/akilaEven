  ...
  <div class="dashboard-main-body">
      ...
      <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
          ...
          <ul class="d-flex align-items-center gap-2">
              ...
              <li>-</li>
              <li class="fw-medium">Liste des Agences</li>
          </ul>
      </div>

      <div class="card basic-data-table">
          <div class="card-header">
              <h5 class="card-title mb-0">Liste des Agences</h5>
          </div>
          {{-- @if($agences->isEmpty())
            <div class="alert alert-info">Aucun agence trouvé</div>
          @endif; --}}
          <div class="card-body">
                      ...
                      <tr>
                          ...
                          <td>
                              <div class="d-flex align-items-center">
                                  ...
                                  <h6 class="text-md mb-0 fw-medium flex-grow-1">{{$agence->nom_agence}}</h6>
                              </div>
                              {{-- @if($agence->logo)
                          ...
                          <td> <span
                                  class="bg-success-focus text-success-main px-24 py-4 rounded-pill fw-medium text-sm">{{$agence ->email}}</span>
                          </td>
                          <td>{{$agence ->ville}}</td>
                          <td>
