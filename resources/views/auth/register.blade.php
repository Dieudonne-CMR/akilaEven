<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            <x-ui.text-input id="name" class="block w-full mt-1" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-ui.text-input id="email" class="block w-full mt-1" type="email" name="email" :value="old('email')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-ui.text-input id="password" class="block w-full mt-1"
                            type="password"
                            name="password"
        ...
        <div class="mt-4">
            ...
            <x-ui.text-input id="password_confirmation" class="block w-full mt-1"
                            type="password"
