...
@section('content')
        ...
        <div class="dashboard-main-body nft-page">
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                {{-- <h6 class="fw-semibold mb-0">Gestion de :@if(session('current_agence_id'))
                    <li class="nav-item">
                        <span class="nav-link">Agence actif : {{ Agence::find(session('current_agence_id'))->nom_agence }}</span>
                    </li>
                    @endif</h6> --}}
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">Gestion de {{ $agence->nom_agence }} </li>
                </ul>
            </div>
                    ...
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="nft-promo-card card radius-12 overflow-hidden position-relative z-1">
                                <img src="assets/images/nft/nft-gradient-bg.png"
                                ...
                                <div class="nft-promo-card__inner d-flex align-items-center">
                                    <div class="nft-promo-card__thumb w-100">
                                        <img src="assets/images/nft/nf-card-img.png" alt=""
                                            class="w-100 h-100 object-fit-cover">
                                    </div>
                                    <div class="flex-grow-1">
                                        <h4 class="mb-16 text-white">Discover The Largest NFTs Marketplace</h4>
                                        <p class="text-white text-md">The largest NFT (Non-Fungible Token) marketplace
                                            is OpenSea. Established in 2017, OpenSea has grown to become the leading
                                            platform for buying, selling, and trading digital assets,</p>
                                        <div class="d-flex align-items-center flex-wrap mt-24 gap-16">
                                            <a href="{{route('locations.create', $agence->id)}}"
                                                class="btn rounded-pill border br-white text-white radius-8 px-32 py-11 hover-bg-white text-hover-neutral-900"> Ajouter une location </a>
                                            <a href="{{ route('event_halls.create',$agence->id) }}"
                                                class="btn rounded-pill btn-primary-600 radius-8 px-28 py-11"> Ajouter une salle </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-12">
                            <h6 class="mb-16">Performances</h6>
                            <div class="row gy-4">
                                <!-- Dashboard Widget Start -->
                                <div class="col-6 col-lg-4 col-sm-6">
                                    <div
                                        class="card px-24 py-16 shadow-none radius-12 border h-100 bg-gradient-start-3">
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex align-items-center flex-wrap gap-16">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span
                                                            class="fw-medium text-secondary-light text-md">Artworks</span>
                                                        <p
                                ...
                                <div class="col-6 col-lg-4 col-sm-6">
                                    <div
                                        class="card px-24 py-16 shadow-none radius-12 border h-100 bg-gradient-start-5">
                                        <div class="card-body p-0">
                                            <div
                                                class="d-flex flex-wrap align-items-center justify-content-between gap-1">
                                                <div class="d-flex align-items-center flex-wrap gap-16">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span
                                                            class="fw-medium text-secondary-light text-md">Auction</span>
                                                        <p
                                                            class="text-sm mb-0 d-flex align-items-center flex-wrap gap-12 mt-12">
                                                            <span
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div
                                        class="card px-24 py-16 shadow-none radius-12 border h-100 bg-gradient-start-2">
                                        <div class="card-body p-0">
                                            <div
                                                class="d-flex flex-wrap align-items-center justify-content-between gap-1">
                                                <div class="d-flex align-items-center flex-wrap gap-16">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <span
                                                            class="fw-medium text-secondary-light text-md">Creators</span>
                                                        <p
                                                            class="text-sm mb-0 d-flex align-items-center flex-wrap gap-12 mt-12">
                                                            <span
                                                                class="bg-success-focus px-6 py-2 rounded-2 fw-medium text-success-main text-sm d-flex align-items-center gap-8">
                        ...
                        <div class="col-12">
                            <div class="mb-16 mt-8 d-flex flex-wrap justify-content-between gap-16">
                                <h6 class="mb-0">Pièces disponibles</h6>
                                <ul class="nav button-tab nav-pills mb-16 gap-12" id="pills-tab-three"
                                    role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link fw-semibold text-secondary-light rounded-pill px-20 py-6 border border-neutral-300 active"
                                            id="pills-button-all-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-button-all" type="button" role="tab"
                                            aria-controls="pills-button-all" aria-selected="false"
                                            tabindex="-1">Salles</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link fw-semibold text-secondary-light rounded-pill px-20 py-6 border border-neutral-300"
                                            id="pills-button-art-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-button-art" type="button" role="tab"
                                            aria-controls="pills-button-art" aria-selected="false"
                                            tabindex="-1">Locations</button>
                                    </li>

                                    {{-- <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link fw-semibold text-secondary-light rounded-pill px-20 py-6 border border-neutral-300"
                                            id="pills-button-music-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-button-music" type="button" role="tab"
                                            aria-controls="pills-button-music" aria-selected="false"
                                            tabindex="-1">Music</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button
                                            class="nav-link fw-semibold text-secondary-light rounded-pill px-20 py-6 border border-neutral-300"
                                ...
                                <div class="tab-pane fade show active" id="pills-button-all" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        @foreach ($eventHalls as $hall )
                                            <div class="col-xxl-3 col-sm-4 col-xs-4">
                                                <div class="nft-card bg-base radius-16 overflow-hidden">
                                                    ...
                                                    @endif
                                                    <div class="p-10">
                                                        <h6 class="text-md fw-bold text-primary-light">{{ $hall->nom_salle }}</h6>
                                                        <div class="d-flex align-items-center gap-8">
                                                            <img src="assets/images/nft/nft-user-img1.png"
                                                                class="w-28-px h-28-px rounded-circle object-fit-cover"
                                                                alt="">
                                                            <span class="text-sm text-secondary-light fw-medium">Localisation: {{$hall->ville->nom}}, {{ $hall->localisation }}</span>
                                                        </div>
                                                        <div
                                                            class="mt-10 d-flex align-items-center justify-content-between gap-8 flex-wrap">
                                                            <span class="text-sm text-secondary-light fw-medium">Capacité:
                                                                <span class="text-sm text-primary-light fw-semibold">{{ $hall->capacite }} personnes</span>
                                                            </span>
                                                            <span
                                                                class="text-sm fw-semibold text-primary-600">{{ number_format($hall->prix, 2, ',', ' ') }} CFA</span>
                                                        </div>
                                                        <div class="d-flex align-items-center flex-wrap mt-12 gap-8">
                                                            <a href="{{route('event-halls.show', $hall->id)}}"
                                                                class="btn rounded-pill border text-neutral-500 border-neutral-500 radius-8 px-12 py-6 bg-hover-neutral-500 text-hover-white flex-grow-1">Details</a>
                                                            <a href="#"
                                                                class="btn rounded-pill btn-primary-600 radius-8 px-12 py-6 flex-grow-1">0 Vues</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        {{-- <div class="col-xxl-3 col-sm-6 col-xs-6">
                                            <div class="nft-card bg-base radius-16 overflow-hidden">
                                                <div class="radius-16 overflow-hidden">
                                                    <img src="assets/images/nft/nft-img2.png" alt=""
                                                        class="w-100 h-100 object-fit-cover">
                                                </div>
                                                <div class="p-10">
                                                    <h6 class="text-md fw-bold text-primary-light">New Figures</h6>
                                                    <div class="d-flex align-items-center gap-8">
                                                        <img src="assets/images/nft/nft-user-img2.png"
                                                            class="w-28-px h-28-px rounded-circle object-fit-cover"
                                                            alt="">
                                                        <span class="text-sm text-secondary-light fw-medium">Watson
                                                            Kristin</span>
                                                    </div>
                                                    <div
                                                        class="mt-10 d-flex align-items-center justify-content-between gap-8 flex-wrap">
                                                        <span class="text-sm text-secondary-light fw-medium">Price:
                                                            <span class="text-sm text-primary-light fw-semibold">1.44
                                                                ETH</span>
                                                        </span>
                                                        <span
                                                            class="text-sm fw-semibold text-primary-600">$4,224.96</span>
                                                    </div>
                                                    <div class="d-flex align-items-center flex-wrap mt-12 gap-8">
                                                        <a href="#"
                                        ...
                                        <div class="col-xxl-3 col-sm-6 col-xs-6">
                                            <div class="nft-card bg-base radius-16 overflow-hidden">
                                                <div class="radius-16 overflow-hidden">
                                                    <img src="assets/images/nft/nft-img3.png" alt=""
                                                        class="w-100 h-100 object-fit-cover">
                                                </div>
                                                <div class="p-10">
                                                    <h6 class="text-md fw-bold text-primary-light">New Figures</h6>
                                                    <div class="d-flex align-items-center gap-8">
                                                        <img src="assets/images/nft/nft-user-img3.png"
                                                            class="w-28-px h-28-px rounded-circle object-fit-cover"
                                                            alt="">
                                                        <span class="text-sm text-secondary-light fw-medium">Watson
                                                            Kristin</span>
                                        ...
                                        <div class="col-xxl-3 col-sm-6 col-xs-6">
                                            <div class="nft-card bg-base radius-16 overflow-hidden">
                                                <div class="radius-16 overflow-hidden">
                                                    <img src="assets/images/nft/nft-img4.png" alt=""
                                                        class="w-100 h-100 object-fit-cover">
                                                </div>
                                                <div class="p-10">
                                                    <h6 class="text-md fw-bold text-primary-light">New Figures</h6>
                                                    <div class="d-flex align-items-center gap-8">
                                                        <img src="assets/images/nft/nft-user-img4.png"
                                                            class="w-28-px h-28-px rounded-circle object-fit-cover"
                                                            alt="">
                                                        <span class="text-sm text-secondary-light fw-medium">Watson
                                                            Kristin</span>
                                ...
                                {{-- <div class="tab-pane fade" id="pills-button-art" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        <div class="col-xxl-3 col-sm-6 col-xs-6">
                                            <div class="nft-card bg-base radius-16 overflow-hidden">
                                                <div class="radius-16 overflow-hidden">
                                                    <img src="assets/images/nft/nft-img1.png" alt=""
                                                        class="w-100 h-100 object-fit-cover">
                                                </div>
                                                <div class="p-10">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-xxl-3 col-sm-6 col-xs-6">
                                            <div class="nft-card bg-base radius-16 overflow-hidden">
                                                ...
                                                <div class="p-10">
                                                    <h6 class="text-md fw-bold text-primary-light">Fantastic Alien
                                                    </h6>
                                                    <div class="d-flex align-items-center gap-8">
                                                        <img src="assets/images/nft/nft-user-img1.png"
                                                            class="w-28-px h-28-px rounded-circle object-fit-cover"
                            ...
                            <div class="card h-100">
                                <div class="card-body p-24">
                                    <div
                                        ...
                                        <select
                                            class="form-select form-select-sm w-auto bg-base border text-secondary-light radius-8 rounded-pill">
                                                    ...
                                                    <tr>
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <h6 class="text-md mb-0 fw-semibold">Spanky &
                                                                        Friends</h6>
                                                                    <span
                                                                        class="text-sm text-secondary-light fw-normal">Owned
                                                                        by ABC</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="d-inline-flex align-items-center gap-12">
                                                                <button type="button"
                                                                    class="text-xl text-success-600"><i
                                        ...
                                        <div class="row gy-3">
                                            <div class="col-sm-6 col-xs-6">
                                                <div class="nft-card bg-base radius-16 overflow-hidden shadow-4">
                                                    <div class="radius-16 overflow-hidden">
                                                        <img src="assets/images/nft/featured-creator1.png"
                                                            alt="" class="w-100 h-100 object-fit-cover">
                                                    </div>
                                                    <div class="p-12">
                                                        <h6 class="text-md fw-bold text-primary-light mb-12">New
                                                            Figures</h6>
                                                        <div class="d-flex align-items-center gap-8">
                                                            <img src="assets/images/nft/bitcoin.png"
                                                                class="w-28-px h-28-px rounded-circle object-fit-cover"
                                                                alt="">
                                                            <span class="text-sm text-secondary-light fw-medium">0.10
                                                                BTC</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-6 col-xs-6">
                                                <div class="nft-card bg-base radius-16 overflow-hidden shadow-4">
                                                    <div class="radius-16 overflow-hidden">
                                                        <img src="assets/images/nft/featured-creator2.png"
                                                            alt="" class="w-100 h-100 object-fit-cover">
                                                    </div>
                                                    <div class="p-12">
                                                        <h6 class="text-md fw-bold text-primary-light mb-12">Abstrac
                                                            Girl</h6>
                                                        <div class="d-flex align-items-center gap-8">
                                                            <img src="assets/images/nft/bitcoin.png"
                                                                class="w-28-px h-28-px rounded-circle object-fit-cover"
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span
                                                    class="text-sm text-secondary-light fw-normal">@kathrynmur</span>
                                            </div>
                                        </div>
                                        <button type="button"
                                            class="btn bg-primary-600 border-primary-600 text-white px-24 rounded-pill follow-btn transition-2">Follow</button>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <span
                                                    class="text-sm text-secondary-light fw-normal">@marvinckin</span>
                                            </div>
                                        </div>
                                        <button type="button"
                                            class="btn bg-primary-600 border-primary-600 text-white px-24 rounded-pill follow-btn transition-2">Follow</button>
