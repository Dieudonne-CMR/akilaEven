...
<x-layout.dashboard-panel class="">
   ...
   <div class="">
      <!-- En-tête de la page -->
      <x-admin.events.listing.event-hall-header-listing :eventHallsCount="count($eventHalls)" />

      <!-- Barre d'actions et filtres -->
      <x-admin.events.listing.event-hall-filters :filters="$filters" />

      <!-- Tableau des salles de fêtes -->
      <x-admin.events.listing.event-hall-table :eventHalls="$eventHalls" />
   </div>
