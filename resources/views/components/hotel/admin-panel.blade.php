...
<div class="p-6 bg-white rounded-lg shadow-sm dark:bg-gray-800">
    ...
    <div class="space-y-4">
        <a href="{{ route('rooms.create', $hotel) }}" class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center">
            <i data-lucide="bed" class="w-4 h-4 mr-2"></i>
            Ajouter une chambre
        </a>
        
        <a href="{{ route('admin.event-hall.create', $hotel) }}" class="w-full text-white bg-purple-600 hover:bg-purple-700 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center justify-center">
        ...
        <button 
            ...
            data-modal-target="update-hotel-modal"
            data-modal-toggle="update-hotel-modal"
        >
