...
<div x-data="eventHallsTable({{ json_encode($agence->eventHalls->load('ville')) }})" class="relative">
    ...
    <div class="flex flex-col mb-4 space-y-3 md:flex-row md:items-center md:justify-between md:space-y-0">
        ...
        <div class="flex flex-wrap items-center gap-2">
            ...
            <!-- Bouton Ajouter -->
            <a href="{{ route('admin.event-hall.create', $agence) }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-300">
    ...
    @else
        <div class="flex flex-col items-center justify-center p-8 text-gray-500 dark:text-gray-400">
            ...
            <p class="mb-6 text-sm">Cet agence n'a pas encore de salles de fête enregistrées.</p>
            <a href="{{ route('admin.event-hall.create', $agence) }}" class="px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-lg hover:bg-purple-700 focus:ring-4 focus:ring-purple-300">
