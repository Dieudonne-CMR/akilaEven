    ...
    <div class="relative w-full max-w-md max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <svg class="w-10 h-10 mb-4 text-gray-400 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 20">
                ...
                <p class="mb-6 text-gray-500 dark:text-gray-400">Choosing the right server storage solution is essential for maintaining data integrity.<p>
