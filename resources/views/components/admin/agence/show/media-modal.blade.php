        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                    Mettre à jour les médias de {{ $agence->nom_agence }}
                </h3>
            ...
            <form action="{{ $updateRoute }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6">
                    <!-- Logo -->
                    <div>
                        <label for="logo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Logo de l'agence</label>
                        <div class="flex items-center space-x-4">
                            <div class="shrink-0 w-20 h-20 overflow-hidden bg-gray-100 rounded-full">
                                @if($agence->logo)
                                    <img id="logo-preview" src="{{ asset('storage/' . $agence->logo) }}" alt="Logo actuel" class="object-cover w-full h-full">
                                @else
                    ...
                    <div class="pt-4 border-t border-gray-200 dark:border-gray-600">
                        <h4 class="mb-4 text-base font-medium text-gray-900 dark:text-white">Bannières de l'agence</h4>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0 w-32 h-20 overflow-hidden bg-gray-100 rounded-lg">
                                    @if($agence->bannier1)
                                        <img id="banner1-preview" src="{{ asset('storage/' . $agence->bannier1) }}" alt="Bannière 1" class="object-cover w-full h-full">
                                    @else
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0 w-32 h-20 overflow-hidden bg-gray-100 rounded-lg">
                                    @if($agence->bannier2)
                                        <img id="banner2-preview" src="{{ asset('storage/' . $agence->bannier2) }}" alt="Bannière 2" class="object-cover w-full h-full">
                                    @else
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-4">
                                <div class="shrink-0 w-32 h-20 overflow-hidden bg-gray-100 rounded-lg">
                                    @if($agence->bannier3)
                                        <img id="banner3-preview" src="{{ asset('storage/' . $agence->bannier3) }}" alt="Bannière 3" class="object-cover w-full h-full">
                                    @else
