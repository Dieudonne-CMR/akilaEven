...

{
    ...
    public function create(Hotel $hotel){
        ...
        /* $villes = Ville::all(); */
        return view('admin.event-hall.create-event-hall');
    }
    ...
    public function store(Request $request, $hotel_id)
    {
        ...
        return redirect()->route('admin.event-hall.create',$hotel_id)->with('success', 'Salle créée !');
    }
    ...
    public function show(EventHall $event_hall){
        ...
        return view('admin.hotel.show-hotel',['eventHall'=>$eventhall]);
    }
