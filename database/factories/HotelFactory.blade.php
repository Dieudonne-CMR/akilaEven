...
class HotelFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $allServices = ['wifi', 'parking', 'piscine', 'restaurant', 'spa', 'bar', 'salle de gym', 'service en chambre'];

        return [
            'nom_hotel'         => $this->faker->company . ' Hôtel',
            'description_hotel' => $this->faker->paragraph(),
            ...
            'bannier1'          => 'https://source.unsplash.com/random/1200x300?hotel&sig=' . $this->faker->unique()->numberBetween(1001, 2000),
