...
Route::get('/site-locations/{location}', [siteController::class, 'detailLocation'])->name('site.detail-locations');
// Creer une réservation de location
Route::post('/create-location-booking', 
[siteController::class, 'storeLocationBooking'])->name('location-booking.store');
